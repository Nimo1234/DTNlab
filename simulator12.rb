...
NUM_SENSORS=10
NUM_BUSES=2
TIME_FINISH = 60*60*6 # Finish time in Seconds
...
# Schedule for bus 1 from the capital city toward the university 
bus1.move("station-001", "station-002",120*60)# station_id 
bus1.stop("station-002",10*60)# station_id

bus1.move("station-002", "station-003",120*60)# station_id 
bus1.stop("station-003",10*60)# station_id

bus1.move("station-003", "station-004",120*60)# station_id 
bus1.stop("station-004",10*60)# station_id


# Schedule for bus 1 from the university  toward the capital city
bus1.move("station-004", "station-003",120*60)# station_id 
bus1.stop("station-003",10*60)# station_id

bus1.move("station-003", "station-002",120*60)# station_id 
bus1.stop("station-002",10*60)# station_id

bus1.move("station-002", "station-001",120*60)# station_id 
bus1.stop("station-001",10*60)# station_id


# Schedule for bus 2 from the capital city toward the university 

bus2.move("station-001","station-002",120*60)#
bus2.stop("station-002",20*60)

bus2.move("station-002","station-003",120*60)#
bus2.stop("station-003",20*60)

bus2.move("station-003","station-004",120*60)#
bus2.stop("station-004",20*60)

# Schedule for bus 2 from the university  toward the capital city
bus2.move("station-004","station-003",120*60)#
bus2.stop("station-003",20*60)

bus2.move("station-003","station-002",120*60)#
bus2.stop("station-002",20*60)

bus2.move("station-002","station-001",120*60)#
bus2.stop("station-001",20*60)

# Schedule for bus 3 from the capital city toward the university 
...
# Schedule for bus 3 from the university  toward the capital city
bus3.move("station-004","station-003",120*60)#
bus3.stop("station-003",30*60)

bus3.move("station-003","station-002",120*60)#
bus3.stop("station-002",30*60)

bus3.move("station-002","station-001",120*60)#
bus3.stop("station-001",30*60)

# add number of Buses 
# Schedule for bus 4 from the capital city toward the university 
...
# Schedule for bus 4 from the university  toward the capital city
bus4.move("station-004", "station-003",120*60)# station_id 
bus4.stop("station-003",30*60)# station_id

bus4.move("station-003", "station-002",120*60)# station_id 
bus4.stop("station-003",30*60)# station_id

bus4.move("station-002", "station-001",120*60)# station_id 
bus4.stop("station-001",30*60)# station_id

#Schedule for bus 5 from the capital city toward the university 
...
# Schedule for bus 5 from the university  toward the capital city
bus5.move("station-004","station-003",120*60)#
bus5.stop("station-003",30*60)

bus5.move("station-003","station-002",120*60)#
bus5.stop("station-002",30*60)

bus5.move("station-002","station-001",120*60)#
bus5.stop("station-001",30*60)

# Modification for the second scenario 
#Schedule for car1 from the capital city toward the university (first round for car1)
...
#Schedule for car1 from the university  toward the capital city (first round for car1)

car1.move("station-004","station-003",120*60)#
car1.stop("station-003",30*60)

car1.move("station-003","station-002",120*60)#
car1.stop("station-002",30*60)

car1.move("station-002","station-001",120*60)#
...
car2.move("station-002","station-003",120*60)#
...
car2.move("station-004","station-003",120*60)#
car2.stop("station-003",30*60)

car2.move("station-003","station-002",120*60)#
car2.stop("station-002",30*60)

car2.move("station-002","station-001",60*60)#
